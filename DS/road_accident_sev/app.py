...
# predict the target from all the input features
       ...
       st.write("Developed By: Purnendu Shukla(@devloper_hs) in collaboration with Avi kumar Talaviya")
       st.markdown("""Reach out to me on: [Twitter](https://twitter.com/devloper_hs) |
